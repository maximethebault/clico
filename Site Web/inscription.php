...
if(isset($_POST['prenom']) AND isset($_POST['nom']) AND isset($_POST['email']) AND isset($_POST['motdepasse'])) { // si le formulaire a été envoyé
    if($_POST['prenom'] != "" AND $_POST['nom'] != "" AND $_POST['email'] != "" AND $_POST['motdepasse'] != "") { //si le formulaire est au complet alors
        if(verif_alpha($_POST['prenom']) && verif_alpha($_POST['nom'])) { //si le prénom et nom sont bien alphabétiques alors
