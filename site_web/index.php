...
<html>
    ...
    <body>
        ...
        <div id="hc_bloc_page">
            ...
            <div id="hc_corps">
                <h1>cliCo, du vestige archéologique au modèle 3D</h1>
				...
				<p><br />Cette chaîne logicielle est fonctionnelle, mais relativement complexe. C'est pourquoi nous avons décider de modifier notre cahier des charges et, au travers d'une <i>interface simple</i> et <i>ergonomique</i>, de <i>faciliter au maximum la numérisation de données archéologiques par un utilisateur</i> : cliCo. </p>
