...
var fq = require("./filequeue/filequeue.js");
// va permettre de limiter le nombre d'opérations en parallèle sur les fichiers (utile dans le cas de gros répertoires où on peut atteindre des limites d'OS)
var fs = new fq(5);
